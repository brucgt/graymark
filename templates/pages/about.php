...
<body>
    ...
    <div class="bg-slate-700 p-1 bottom-dev mt-5 lg:p-10">
        <div class="text-3xl font-bold text-center pt-12 text-white md:text-5xl md:p-10">
            <h1>OUR LOCATION</h1>
        </div>

        <div class="flex flex-col items-center justify-center m-auto my-5 bg-slate-900 rounded-lg shadow-md w-[97%] overflow-hidden sm:w-[80%]  md:w-[75%] lg:w-[95%] xl:w-[80%]  lg:flex-row">
            <div class="flex flex-col justify-between p-8 leading-normal text-slate-100 lg:w-1/2">
                <h5 class="mb-2 text-2xl font-bold tracking-tight ">BUSINESS ADDRESS</h5>
                <p class="mb-3 font-normal ">1902A EAST TOWER 19TH FLOOR, PHIL STOCK EXCHANGE BLDG, PASIG CITY, PHILIPPINES.</p>
                <h5 class="mb-2 text-2xl font-bold tracking-tight ">CONTACT DETAILS</h5>
                <p class="mb-3 font-bold ">LANDLINE:</p>
                <p class="mb-3 font-normal ">(+63) 286307484</p>
                <p class="mb-3 font-bold ">MOBILE:</p>
                <p class="mb-3 font-normal ">(+63) 97 - 7786 - 426</p>
                <p class="mb-3 font-bold ">E-MAIL ADDRESSES:</p>
                <p class="mb-3 font-normal ">malou.superio@graymark.com.ph</p>
                <p class="mb-3 font-normal ">girlie.espiritu@graymark.com.ph</p>
            </div>
